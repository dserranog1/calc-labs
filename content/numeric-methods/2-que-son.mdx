...
En lugar de encontrar una solución simbólica —como una primitiva escrita con funciones conocidas—, los métodos numéricos nos dan **números** que se acercan mucho al valor real.
